...
(function (scope,undefined) {
    ...
    var urls = {
            ...
            notification:'/push/',
            extensionURL:'https://api.built.io/v1/functions/'
        },
        Built,
        _Cache="only_network",
        appUserInfo = null,
...
/////////////////////////////////////////////////      built.io functions        ///////////////////////////////////////////////////
    (function (root) {
         ...
         * @param {String} tenant tenant_uid for your application 
         * @static
         * @memberof Built
        ...
        Built.fn = (Built.__proto__?Built.__proto__:Built.prototype);

        /**
         * remove header for built.io rest calls.
         * @param {String} Key specify the key name to remove from common headers.
         * @static
         * @memberof Built
         * @return {Built} returns Built object
         */
         ...
         * @return {Built} returns Built object
         */
        Built.fallbackForCORS=function(boolean){
    ...
    (function(root){
        ...
        Built.Events= {
            ...
            trigger:function(eventName){
                if(! this.__listeners || 
                    typeof this.__listeners!== "object"){
                    return this;
                }
                var me=this;
                eventName=eventName.split(",");
    ...
    (function (root) {
        ...
        Built.User.setCurrentUser = function (key) {
            if (typeof key == 'object' && key !=null && key.authtoken) {
                appUserInfo = key;
                Headers['authtoken'] = key.authtoken;
        ...
        */
         ...
         * @return {Built.Promise} returns Built.Promise
         */
        Built.User.requestResetPassword = function (email, option) {
            option = option || {};
            ...
            var rets= REST.USER.forgetPassword(Headers, data, cb, {});
            myPromise._XHR=rets._XHR;
            myPromise.abort=rets.abort;
            return myPromise;
        }
        ...
        /**
         * login with Google (oAuth).<br/>
         * <b>only for NodeJs.</b>
         * @param {Object} params JSON containing clientId, clientSecret, redirectURI.
         * @param {String} Code Access code returned by google
         * @param {Object} [callback] object containing callbacks. eg: {onSuccess:function(data){}, onError: function(err){}}
         * @static
         * @memberof Built.User
         * @return {Object} returns Built.User object
         */
...
////////////////////////////////////////////////        Built.Object             ///////////////////////////////////////////////////
    (function (root) {
         ...
         */
        Built.Object = function (classUid, attrbs) {
            var _schema = null;
            var attributes = {};
            var object_uid = null;
            var __q = {};
            ...
            this.upsert=function (key) {
                if(typeof key ==='string' && val){
                    ...
                    obj_options['UPSERT'][key]=val;
                }else if(Built.Util.dataType(key)=='object'){
                    if(typeof obj_options['UPSERT'] ==='undefined'){obj_options['UPSERT']={}}
             ...
             * @param {String|Array} value to enter in field
            ...
            this.pushValue=function (key,val,index) {
                if(typeof arguments[0] ==='string' && arguments[0] !=""){
                    var pushData={"PUSH":{}}
                    var _args=Array.prototype.slice.apply(arguments,[1,arguments.length]);
                    for(var i=0,j=_args.length;i<j;i++){
                        var itemDataType=typeof _args[i];//Built.Util.dataType(_args[i]);
                        if(itemDataType=='object'){
                            if(typeof pushData['PUSH']['data'] === 'undefined'){
                                pushData['PUSH']['data']=[];
                            }
                            pushData['PUSH']['data'].push.apply(pushData['PUSH']['data'],_args[i]);
                        }else if(itemDataType=='number'){
                            pushData['PUSH']['index']=_args[i];
                        }else if(itemDataType =='string'){
                            if(typeof pushData['PUSH']['data'] === 'undefined'){
                                pushData['PUSH']['data']=[];
                            }
                            pushData['PUSH']['data'].push(_args[i]);
                        }
                    }
                    if(typeof pushData['PUSH']['data'] !=='undefined' ||
                        pushData['PUSH']['index'] !=='undefined'){
                        if(typeof shadow[key] === 'undefined'){shadow[key]={}};
                        shadow[key]=Built.Util.mix(shadow[key],pushData);
                    }
                }
                return this;
            }
             ...
             * @param {String} Key filter name to include.
             * @param {String} filter value to include.
             * @name includeFilter
             * @memberOf Built.Object
             * @function
             * @instance
            ...
            this.save= function (callback) {
                ...
                if (typeof object_uid == 'string' && object_uid.length > 0) {
                    var rets=REST.OBJECT.update(_head, { object: shadow }, cb, option);
                    myPromise._XHR=rets._XHR;
                    myPromise.abort=rets.abort;
                    return myPromise;
                } else {
            ...
            /**
             * add header for this Built.Object REST call.
             * @name addHeader
    ...
    (function (root) {
        ...
        Built.Query = function (className) {
                ...
                if(typeof Backbone !== "undefined" && Backbone.Model && Backbone.Collection){
                    var model=Backbone.Model.extend({
                        ...
                        sync:function(type,obj,options){
                            ...
                            options=options||{};
                            var builtModel=new Built.Object(class_uid,this.toJSON());
            ...
            */
            ...
            /**
             * add header for this Built.Query REST call.
             * @name addHeader
             * @param {String} Key Header Name
             * @param {String} Value Header Value
             * @memberOf Built.Query
...
////////////////////////////////////////////////        Built.Promise            //////////////////////////////////////////////////
    (function(root){
                ...
                var invokeIt=function(result,isError){
                    if (result && Built.Promise.isPromise(result)) {
                        ...
                        if(isError || isErrorReturned){
                            promise.reject.call(promise, result);
                        }else{
                            promise.resolve.call(promise, result);
                        }
                    }
                }
        ...
        Built.Promise.when=function(){
            ...
            var retPromise= new Built.Promise();
            if(totalPromises==0){
                retPromise.resolve();
                return retPromise;
            }
            ...
            var errorFaced=false;


            var oneCompleted = function() {
                --leftPromises;
                if (leftPromises === 0) {
                    if (errorFaced) {
...
////////////////////////////////////////////////        Built.Application        //////////////////////////////////////////////////
    (function(root){
         ...
         * @example
         * var roles=Buiilt.Application.fetchRoles(); 
         * roles.where('name','admin') 
         * .exec() 
         * .success(function(rolessArray, responseObject){ 
         *    //callback logic
         * });
         * @memberOf Built.Application
         * @function
         * @name Built.Application.fetchRoles
         * @static
         * @return {Built.Query} returns Built.Query to get application role's object.
         */
        Built.Application.fetchRoles=function () {
...
////////////////////////////////////////////////        Built.Extension          ///////////////////////////////////////////////////
    (function(root){
         ...
         * @return {Built.Promise} returns Built.Promise
         */
        Built.Extension.execute= function (logicId,reqBody,callback){
            ...
            if(typeof appId =='string' &&
                ...
                reqBody=reqBody||{};
                if(reqBody == null || typeof reqBody !="object"){reqBody={}}
                var url=serializeURL(urls.extensionURL+logicId);
                var head={application_api_key:appId};
                var cb=function(data,res){
                    if(res.status==200){
                        if(typeof callback.onSuccess=='function'){
                            callback.onSuccess(data,res);
                ...
                var rets= httpPost(url,head,reqBody,cb);
                myPromise._XHR=rets._XHR;
                myPromise.abort=rets.abort;
            }else{
                if(typeof callback=="function"){
                    callback({error_message:"parameter missing"},null);
                }
            }
            return myPromise;
        }
         ...
         * @param {String} logicName define the unique name for the logic. It will be used to execute the logic later on.
...
////////////////////////////////////////////////        Built.Analytics          //////////////////////////////////////////////////
    (function(root){
        ...
        Built.Analytics.Event=function(euid){
            ...
            /**
             * add properties and other attributes in event.
             ...
             */
            this.addAttributes= function(prop,prevEvent,createdAt) {
                if(typeof prop == 'object'){
                    var _prop={properties:prop};
                    if(typeof prevEvent=='string'){
                        _prop['previous_event_uid']=prevEvent;
                    }
                    if(createdAt instanceof Date && typeof createdAt.toISOString=='function'){
                        _prop['created_at']=createdAt.toISOString();
                    }
                    props.push(_prop);
                    return this;
                }
             ...
             * @param {Built.Analytics.Event} Built.Analytics.Event add the Built.Event object.
             * @memberOf Built.Analytics.Event
             * @name appendEvent
             * @function
             * @instance
    ...
    var REST = {
        ...
        AS:{
            trigger:function(headers,data,callback){
                var url =  urls.Base+'/events/trigger_multiple';
                url=serializeURL(url);
                headers=headers||{};
                data=data||{};
                if (headers.application_api_key && headers.application_uid) {
...
////////////////////////////////////////////////        Web HTTP Request         ///////////////////////////////////////////////////
    ...
    if(isNode==false){postMessageListener()}
    ...
    var nodeHTTPRequest = function (url, headers, data, method, callback) {
        ...
        data = JSON.stringify(data);
        return httpModule.post({url:url, headers: headers, body: data, json:true},
            function (error, response, body) {
                Built.Events.trigger('http:end');
                callback((body?body:error), response);
            }
        );
        Built.Events.trigger('http:start');
    }
    if (isNode) { httpRequest = nodeHTTPRequest } else { httpRequest = browserHTTPRequest }
